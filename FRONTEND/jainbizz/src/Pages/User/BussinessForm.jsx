                    ...
                    {currentStep === 2 && <div>
                        ...
                        <div class='h-28'>
                            <div class="-m-2 flex flex-wrap">
                                <div class="w-full  px-3 sm:w-1/2">
                                <p>Your Company is Certified for ISO ?</p>
                                    <div class="mb-5 ">
                                ...
                                <div class="w-full px-3 py-5 sm:w-1/2">
                                    <div class="mb-5">
                        ...
                        <div class='h-28'>
                            <div class="-mx-4 flex flex-row">
                                <div class="w-full px-3 py-3 sm:w-1/2">
                                    <div class="mb-5">
                                        <p>Do you have FSSAI Number ?</p>
                                        <label class="flex bg-gray-100 text-gray-700 rounded-md px-3 py-2 my-3  hover:bg-yellow-300 ring-yellow-500 ring-offset-2 cursor-pointer ">

                                            <input type="radio" name="fssai_check" value="true" id="fssai_check" checked={values.fssai_check === 'true'} onChange={handlechange} class="accent-purple-200 focus-within:accent-[#6A64F1]" />
                                ...
                                <div class="w-full px-3 py-2 sm:w-1/2">
                                    <div class="mb-5 ">

                                        <label class="flex items-center justtex bg-gray-100 text-gray-700 rounded-md px-3 py-2 my-5   hover:bg-yellow-300 cursor-pointer ">

                                            <input type="radio" name="fssai_check" value="false" id="fssai_check" checked={values.fssai_check === 'false'} onChange={handlechange} class=" accent-purple-200 focus-within:accent-[#6A64F1]" />
                                            <strong class="pl-2 my-2">No</strong>
